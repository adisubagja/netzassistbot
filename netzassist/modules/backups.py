...
import netzassist.modules.sql.notes_sql as sql
from netzassist import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, spamcheck, TEMPORARY_DATA
from netzassist.__main__ import DATA_IMPORT
from netzassist.modules.helper_funcs.chat_status import user_admin
from netzassist.modules.helper_funcs.misc import build_keyboard, revert_buttons
from netzassist.modules.helper_funcs.msg_types import get_note_type
from netzassist.modules.rules import get_rules
from netzassist.modules.helper_funcs.string_handling import button_markdown_parser, make_time

# SQL
import netzassist.modules.sql.antiflood_sql as antifloodsql
import netzassist.modules.sql.blacklist_sql as blacklistsql
import netzassist.modules.sql.blsticker_sql as blackliststksql
from netzassist.modules.sql import disable_sql as disabledsql
from netzassist.modules.sql import cust_filters_sql as filtersql
from netzassist.modules.sql import languages_sql as langsql
import netzassist.modules.sql.locks_sql as locksql
from netzassist.modules.locks import LOCK_TYPES
from netzassist.modules.sql import notes_sql as notesql
from netzassist.modules.sql import reporting_sql as reportsql
import netzassist.modules.sql.rules_sql as rulessql
from netzassist.modules.sql import warns_sql as warnssql
import netzassist.modules.sql.welcome_sql as welcsql

from netzassist.modules.connection import connected

from netzassist.modules.helper_funcs.msg_types import Types
from netzassist.modules.languages import tl
from netzassist.modules.helper_funcs.alternate import send_message
...
def import_data(update, context):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			# If backup is from netzassist
			if data.get('bot_base') == "netzassist":
				imp_antiflood = False
				imp_blacklist = False
			...
			send_message(update.effective_message, tl(update.effective_message, "Telah terjadi kesalahan dalam import backup netzassist!"), parse_mode="markdown")
			LOGGER.exception("An error when importing from netzassist base!")
			return
...
def export_data(update, context):
	...
	f = open("{}-netzassist.backup".format(chat_id), "w")
	...
	try:
		...
		pass
	os.remove("{}-netzassist.backup".format(chat_id)) # Cleaning file
