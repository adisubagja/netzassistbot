...
from netzassist import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, spamcheck
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from netzassist.modules.helper_funcs.alternate import typing_action
from netzassist.modules import ALL_MODULES
from netzassist.modules.languages import tl
from netzassist.modules.helper_funcs.chat_status import is_user_admin
from netzassist.modules.helper_funcs.misc import paginate_modules
from netzassist.modules.helper_funcs.verifier import verify_welcome
from netzassist.modules.sql import languages_sql as langsql

from netzassist.modules.connection import connect_button
from netzassist.modules.languages import set_language
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("netzassist.modules." + module_name)
