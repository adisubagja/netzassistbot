...
if ENV:
	...
	from netzassist.config import Development as Config
...
from netzassist.modules.helper_funcs.handlers import CustomCommandHandler
 
if CUSTOM_CMD and len(CUSTOM_CMD) >= 1:
	tg.CommandHandler = CustomCommandHandler
 
try:
	from netzassist.antispam import antispam_restrict_user, antispam_cek_user, detect_user
